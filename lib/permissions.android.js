...
const permissionTypes = {
  ...
  writeContacts: PermissionsAndroid.PERMISSIONS.WRITE_CONTACTS,
  ...
  outgoingCalls: PermissionsAndroid.PERMISSIONS.PROCESS_OUTGOING_CALLS,
  readSms: PermissionsAndroid.PERMISSIONS.READ_SMS,
  receiveSms: PermissionsAndroid.PERMISSIONS.RECEIVE_SMS,
  receiveMms: PermissionsAndroid.PERMISSIONS.RECEIVE_MMS,
  sendSms: PermissionsAndroid.PERMISSIONS.SEND_SMS,
  receiveWapPush: PermissionsAndroid.PERMISSIONS.RECEIVE_WAP_PUSH,
  addVoiceMail: PermissionsAndroid.PERMISSIONS.ADD_VOICEMAIL,
  sip: PermissionsAndroid.PERMISSIONS.USE_SIP,
  bodySensors: PermissionsAndroid.PERMISSIONS.BODY_SENSORS,
}
